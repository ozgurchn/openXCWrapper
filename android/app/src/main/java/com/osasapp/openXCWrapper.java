...
public class openXCWrapper extends ReactContextBaseJavaModule {
    ...
    public openXCWrapper(ReactApplicationContext reactContext, Activity activity) {
        super(reactContext);
